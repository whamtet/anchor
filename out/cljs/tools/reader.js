...
var G__5396 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__5396;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__5398 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__5398,ch);
...
if(("\\" === ch__$1)){
var ch_5399__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_5399__$2 == null)){
cljs.tools.reader.reader_types.reader_error.call(null,rdr,"EOF while reading regex");
} else {
}

sb.append(ch_5399__$2);
} else {
}

var G__5400 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__5400;
continue;
}
}
...
var args5401 = [];
var len__5201__auto___5404 = arguments.length;
var i__5202__auto___5405 = (0);
while(true){
if((i__5202__auto___5405 < len__5201__auto___5404)){
args5401.push((arguments[i__5202__auto___5405]));

var G__5406 = (i__5202__auto___5405 + (1));
i__5202__auto___5405 = G__5406;
continue;
} else {
}
break;
...
var vec__5413 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__5413,(0),null);
var start_column = cljs.core.nth.call(null,vec__5413,(1),null);
...
var G__5414 = cljs.core.conj_BANG_.call(null,a,form);
a = G__5414;
continue;
}
}
...
var _STAR_read_delim_STAR_5416 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_5416;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__5419 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__5419,(0),null);
var start_column = cljs.core.nth.call(null,vec__5419,(1),null);
var the_list = cljs.tools.reader.read_delimited.call(null,")",rdr,opts,pending_forms);
var vec__5420 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__5420,(0),null);
var end_column = cljs.core.nth.call(null,vec__5420,(1),null);
...
var vec__5423 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__5423,(0),null);
var start_column = cljs.core.nth.call(null,vec__5423,(1),null);
var the_vector = cljs.tools.reader.read_delimited.call(null,"]",rdr,opts,pending_forms);
var vec__5424 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__5424,(0),null);
var end_column = cljs.core.nth.call(null,vec__5424,(1),null);
...
var vec__5427 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__5427,(0),null);
var start_column = cljs.core.nth.call(null,vec__5427,(1),null);
...
var vec__5428 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__5428,(0),null);
var end_column = cljs.core.nth.call(null,vec__5428,(1),null);
...
var sb = (function (){var G__5431 = (new goog.string.StringBuffer());
G__5431.append(initch);
...
var G__5433 = (function (){var G__5432 = sb;
G__5432.append(ch);

return G__5432;
})();
var G__5434 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__5433;
ch = G__5434;
continue;
}
...
switch (G__5441) {
case "\\":
var G__5445 = (function (){var G__5442 = sb;
G__5442.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__5442;
})();
var G__5446 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__5445;
ch = G__5446;
continue;
...
break;
default:
var G__5447 = (function (){var G__5443 = sb;
G__5443.append(ch);

return G__5443;
})();
var G__5448 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__5447;
ch = G__5448;
continue;
...
var vec__5450 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__5450,(0),null);
var end_column = cljs.core.nth.call(null,vec__5450,(1),null);
...
var line = cljs.core.nth.call(null,vec__5453,(0),null);
var column = cljs.core.nth.call(null,vec__5453,(1),null);
...
var vec__5462 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__5462,(0),null);
var column = cljs.core.nth.call(null,vec__5462,(1),null);
...
var vec__5465 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__5465,(0),null);
var column = cljs.core.nth.call(null,vec__5465,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.reader_types.reader_error.call(null,rdr,"Metadata must be Symbol, Keyword, String or Map");
...
var vec__5470 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__5470,(0),null);
var start_column = cljs.core.nth.call(null,vec__5470,(1),null);
var start_column__$1 = (cljs.core.truth_(start_column)?((start_column - (1)) | (0)):null);
var the_set = cljs.core.set.call(null,cljs.tools.reader.read_delimited.call(null,"}",rdr,opts,pending_forms));
var vec__5471 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__5471,(0),null);
var end_column = cljs.core.nth.call(null,vec__5471,(1),null);
...
var G__5473 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__5473,true,null,opts,pending_forms);
...
var _STAR_suppress_read_STAR_5475 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_5475;
}});
...
var G__5477 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__5477,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__5477,rdr,first_line);
...
var G__5482 = matched;
var G__5483 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__5482;
finished = G__5483;
continue;
} else {
...
var _STAR_suppress_read_STAR_5485 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_5485;
}}
} else {
return cljs.tools.reader.reader_types.reader_error.call(null,rdr,"EOF while reading character");
}
...
var arg_env5488 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__5489 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__5489,"(");
...
var G__5490 = (i + (1));
var G__5491 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4143__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4143__auto__)){
return or__4143__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env5488;
}});
/**
...
var ch = temp__4423__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__5493 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__5493);
...
var G__5497 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__5496;
key_vals = G__5497;
continue;
} else {
...
var gensym_env5505 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env5505;
}});
...
args5512.push((arguments[i__5202__auto___5517]));
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args5512.length)].join('')));
...
}catch (e5515){if((e5515 instanceof Error)){
var e = e5515;
...
var args5520 = [];
var len__5201__auto___5526 = arguments.length;
var i__5202__auto___5527 = (0);
while(true){
if((i__5202__auto___5527 < len__5201__auto___5526)){
args5520.push((arguments[i__5202__auto___5527]));

var G__5528 = (i__5202__auto___5527 + (1));
i__5202__auto___5527 = G__5528;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args5520.length)].join('')));
...
var map__5524__$1 = ((((!((map__5524 == null)))?((((map__5524.cljs$lang$protocol_mask$partition0$ & (64))) || (map__5524.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__5524):map__5524);
var opts = map__5524__$1;
var eof = cljs.core.get.call(null,map__5524__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var args5530 = [];
var len__5201__auto___5533 = arguments.length;
var i__5202__auto___5534 = (0);
while(true){
if((i__5202__auto___5534 < len__5201__auto___5533)){
args5530.push((arguments[i__5202__auto___5534]));

var G__5535 = (i__5202__auto___5534 + (1));
i__5202__auto___5534 = G__5535;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args5530.length)].join('')));
