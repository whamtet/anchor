...
var req = map__8551__$1;
var body = cljs.core.get.call(null,map__8551__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
var request_method = cljs.core.get.call(null,map__8551__$1,new cljs.core.Keyword(null,"request-method","request-method",1764796830));
...
busboy.on("file",((function (busboy,params,handler_promise,map__8551,map__8551__$1,req,body,request_method){
return (function (fieldname,file,filename,encoding,mimetype){
var data = redlobster.stream.read_binary_stream.call(null,file);
return redlobster.promise.defer_until_realised.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [data], null),((function (data,busboy,params,handler_promise,map__8551,map__8551__$1,req,body,request_method){
return (function (){
...
});})(data,busboy,params,handler_promise,map__8551,map__8551__$1,req,body,request_method))
);
});})(busboy,params,handler_promise,map__8551,map__8551__$1,req,body,request_method))
);

busboy.on("field",((function (busboy,params,handler_promise,map__8551,map__8551__$1,req,body,request_method){
...
busboy.on("finish",((function (busboy,params,handler_promise,map__8551,map__8551__$1,req,body,request_method){
return (function (){
