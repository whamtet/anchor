...
var _STAR_html_mode_STAR_6158 = hiccups.runtime._STAR_html_mode_STAR_;
hiccups.runtime._STAR_html_mode_STAR_ = mode;

try{return f.call(null);
}finally {hiccups.runtime._STAR_html_mode_STAR_ = _STAR_html_mode_STAR_6158;
}});
/**
...
hiccups.runtime.render_attribute = (function hiccups$runtime$render_attribute(p__6159){
var vec__6161 = p__6159;
var name = cljs.core.nth.call(null,vec__6161,(0),null);
var value = cljs.core.nth.call(null,vec__6161,(1),null);
if(value === true){
if(cljs.core.truth_(hiccups.runtime.xml_mode_QMARK_.call(null))){
 ...
 */
hiccups.runtime.normalize_element = (function hiccups$runtime$normalize_element(p__6162){
var vec__6165 = p__6162;
var tag = cljs.core.nth.call(null,vec__6165,(0),null);
var content = cljs.core.nthnext.call(null,vec__6165,(1));
if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string'))){
throw [cljs.core.str(tag),cljs.core.str(" is not a valid tag name")].join('');
} else {
}

var vec__6166 = cljs.core.re_matches.call(null,hiccups.runtime.re_tag,hiccups.runtime.as_str.call(null,tag));
var _ = cljs.core.nth.call(null,vec__6166,(0),null);
var tag__$1 = cljs.core.nth.call(null,vec__6166,(1),null);
var id = cljs.core.nth.call(null,vec__6166,(2),null);
var class$ = cljs.core.nth.call(null,vec__6166,(3),null);
...
var vec__6168 = hiccups.runtime.normalize_element.call(null,element);
var tag = cljs.core.nth.call(null,vec__6168,(0),null);
var attrs = cljs.core.nth.call(null,vec__6168,(1),null);
var content = cljs.core.nth.call(null,vec__6168,(2),null);
if(cljs.core.truth_((function (){var or__4143__auto__ = content;
