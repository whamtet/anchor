...
return cljs.core.vec.call(null,cljs.core.mapcat.call(null,(function (p1__6789_SHARP_){
return cljs.core.remove.call(null,(function (x){
return (cljs.core.seq_QMARK_.call(null,x)) || (cljs.core.not.call(null,x));
}),cljs.core.tree_seq.call(null,cljs.core.seq_QMARK_,cljs.core.identity,p1__6789_SHARP_));
}),v));
});
...
return f.call(null,cljs.core.mapv.call(null,(function (p1__6790_SHARP_){
return cljs_pdfkit$optimize_dom$postwalk.call(null,f,p1__6790_SHARP_);
}),m));
} else {
return m;
}
...
return f.call(null,cljs.core.mapv.call(null,(function (p1__6791_SHARP_){
return cljs_pdfkit$optimize_dom$complete_postwalk.call(null,f,p1__6791_SHARP_);
...
if(cljs.core.vector_QMARK_.call(null,m)){
if(cljs.core.truth_(cljs.core.some.call(null,cljs_pdfkit.optimize_dom.element_tag_QMARK_,m))){
return cljs.core.mapv.call(null,(function (p1__6792_SHARP_){
return cljs_pdfkit$optimize_dom$prewalk.call(null,f,p1__6792_SHARP_);
}),f.call(null,m));
} else {
return m;
}
 ...
 */
cljs_pdfkit.optimize_dom.add_style = (function cljs_pdfkit$optimize_dom$add_style(p__6793){
var vec__6795 = p__6793;
var tag = cljs.core.nth.call(null,vec__6795,(0),null);
var style = cljs.core.nth.call(null,vec__6795,(1),null);
var children = cljs.core.nthnext.call(null,vec__6795,(2));
var v = vec__6795;
 ...
 */
cljs_pdfkit.optimize_dom.refactor_tag = (function cljs_pdfkit$optimize_dom$refactor_tag(p__6796){
var vec__6798 = p__6796;
var tag = cljs.core.nth.call(null,vec__6798,(0),null);
var style = cljs.core.nth.call(null,vec__6798,(1),null);
var children = cljs.core.nthnext.call(null,vec__6798,(2));
var v = vec__6798;
...
cljs_pdfkit.optimize_dom.percolate_up = (function cljs_pdfkit$optimize_dom$percolate_up(p__6800){
var vec__6802 = p__6800;
var tag = cljs.core.nth.call(null,vec__6802,(0),null);
var style = cljs.core.nth.call(null,vec__6802,(1),null);
var children = cljs.core.nthnext.call(null,vec__6802,(2));
var v = vec__6802;
...
return cljs.core.vec.call(null,cljs.core.list_STAR_.call(null,tag,cljs.core.merge.call(null,style,common_map),cljs.core.map.call(null,((function (common_map,vec__6802,tag,style,children,v){
return (function (p1__6799_SHARP_){
return cljs.core.update_in.call(null,p1__6799_SHARP_,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(1)], null),cljs_pdfkit.optimize_dom.map_difference,common_map);
});})(common_map,vec__6802,tag,style,children,v))
,children)));
}
});
cljs_pdfkit.optimize_dom.percolate_down = (function cljs_pdfkit$optimize_dom$percolate_down(p__6804){
var vec__6806 = p__6804;
var tag = cljs.core.nth.call(null,vec__6806,(0),null);
var style = cljs.core.nth.call(null,vec__6806,(1),null);
var children = cljs.core.nthnext.call(null,vec__6806,(2));
var v = vec__6806;
...
return cljs.core.vec.call(null,cljs.core.list_STAR_.call(null,tag,cljs_pdfkit.optimize_dom.map_difference.call(null,style,godown),cljs.core.map.call(null,((function (godown,vec__6806,tag,style,children,v){
return (function (p1__6803_SHARP_){
return cljs.core.update_in.call(null,p1__6803_SHARP_,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(1)], null),((function (godown,vec__6806,tag,style,children,v){
return (function (child_opts){
return cljs.core.merge.call(null,godown,child_opts);
});})(godown,vec__6806,tag,style,children,v))
);
});})(godown,vec__6806,tag,style,children,v))
,children)));
}
